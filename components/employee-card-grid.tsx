...
function EmployeeViewModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[130] flex items-end justify-center bg-[rgba(52,47,43,0.34)] p-3 sm:items-center sm:p-6">
      <div className="w-full max-w-2xl rounded-[28px] border border-[rgba(218,210,200,0.8)] bg-[rgba(255,252,248,0.98)] shadow-[0_28px_60px_-30px_rgba(82,66,51,0.28)]">
        <div className="flex items-start justify-between gap-4 border-b border-[rgba(226,219,211,0.82)] px-5 py-4">
          <div>
...
function EmployeeTimelineModal({
  ...
  const dateEvents = useMemo(() => {
    ...
    employee.attendanceRecords.forEach((record) => {
      pushEvent(record.date, {
        type: "attendance",
        label: record.status === "ABSENT" ? `Absent${record.remarks ? `: ${record.remarks}` : ""}` : "Present",
        tone: record.status === "ABSENT" ? "red" : "green"
      });
    });
  ...
  return createPortal(
    <div className="fixed inset-0 z-[130] flex items-end justify-center bg-[rgba(52,47,43,0.34)] p-3 sm:items-center sm:p-6">
      <div className="w-full max-w-4xl rounded-[28px] border border-[rgba(218,210,200,0.8)] bg-[rgba(255,252,248,0.98)] shadow-[0_28px_60px_-30px_rgba(82,66,51,0.28)]">
        <div className="flex items-start justify-between gap-4 border-b border-[rgba(226,219,211,0.82)] px-5 py-4">
          <div>
          ...
          <div>
            <div className="flex items-center justify-between gap-3">
              <button
                ...
                className="rounded-2xl border border-[rgba(218,210,200,0.82)] bg-white px-3 py-2 text-sm font-semibold text-stone-700 transition hover:bg-[#faf7f2]"
              >
                Prev
              </button>
            ...
            <div className="mt-4 overflow-hidden rounded-[24px] border border-[rgba(226,219,211,0.84)] bg-[rgba(255,250,244,0.92)]">
              <div className="grid grid-cols-7 border-b border-[rgba(226,219,211,0.84)] bg-[rgba(250,244,236,0.95)]">
                  ...
                  return (
                    <button
                      ...
                      className={`min-h-[88px] border-t border-[rgba(226,219,211,0.72)] px-2 py-2 text-left transition ${
                        ...
                        inMonth ? "bg-white/55" : "bg-[rgba(248,244,238,0.7)] text-stone-400"
                    ...
                    >
                      <div className="flex items-center justify-between gap-1">
                        ...
                        <div className="flex items-center gap-1">
                          {hasPayday ? <span className="h-2.5 w-2.5 rounded-full bg-amber-400" /> : null}
            ...
            <div className="mt-3 flex flex-wrap items-center gap-3 text-xs text-[#7a7168]">
              ...
              <span className="inline-flex items-center gap-2"><span className="h-2.5 w-2.5 rounded-full bg-amber-400" /> Payday / start</span>
            </div>
          </div>

          <div className="rounded-[24px] border border-[rgba(226,219,211,0.84)] bg-[rgba(255,250,244,0.92)] p-4">
            ...
            <div className="mt-4 space-y-3">
              {selectedEvents.length ? (
                ...
                <div className="rounded-[20px] border border-[rgba(226,219,211,0.84)] bg-white px-4 py-4 text-sm text-[#7a7168]">
...
export function EmployeeCardGrid({ employees }: { employees: EmployeeCardItem[] }) {
  ...
  return (
    <>
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <div ref={menuOpenFor === employee.id ? menuRef : undefined} className="relative">
                  <button
                    ...
                    className="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-[rgba(218,210,200,0.84)] bg-[rgba(255,255,255,0.9)] text-stone-500 transition hover:bg-white hover:text-stone-900"
                  ...
                  {menuOpenFor === employee.id ? (
                    <div className="absolute right-0 top-12 z-20 w-48 rounded-[20px] border border-[rgba(218,210,200,0.84)] bg-[rgba(255,252,248,0.98)] p-2 shadow-[0_18px_36px_-24px_rgba(82,66,51,0.28)]">
                      <button
                        type="button"
                        onClick={() => {
                        ...
                        className="flex w-full items-center gap-2 rounded-2xl px-3 py-2.5 text-left text-sm font-medium text-stone-700 transition hover:bg-[#f7f2eb]"
                      >
                      ...
                      <form action={toggleEmployeeStatusAction}>
                        ...
                        <button className="flex w-full items-center gap-2 rounded-2xl px-3 py-2.5 text-left text-sm font-medium text-stone-700 transition hover:bg-[#f7f2eb]">
      ...
      {deleteEmployee ? (
        <div className="fixed inset-0 z-[130] flex items-end justify-center bg-[rgba(52,47,43,0.34)] p-3 sm:items-center sm:p-6">
          <div className="w-full max-w-md rounded-[28px] border border-[rgba(218,210,200,0.8)] bg-[rgba(255,252,248,0.98)] p-5 shadow-[0_28px_60px_-30px_rgba(82,66,51,0.28)]">
